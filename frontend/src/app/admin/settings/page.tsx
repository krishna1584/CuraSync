...
export default function AdminSettingsPage() {
  const [settings, setSettings] = useState({
    hospitalName: 'CuraSync Hospital',
    hospitalEmail: 'admin@curasync.com',
      ...
      <div className="bg-white shadow">
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="py-6">
            ...
            <p className="mt-1 text-sm text-gray-500">Manage your hospital system settings</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-900">Allow Public Signup</p>
